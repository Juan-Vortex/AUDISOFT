...
public class productoService {
    ...
    // dev_JB - creamos el cuarto metodo editar un producto

        // el metodo para editar el producto es el mismo de guardar en sprintboot 
        // solo que le agregamos el id al objeto que se envia y en lugar de crear este encuentra y actualiza
